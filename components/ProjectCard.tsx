...
const ProjectCard: FunctionComponent<{
  ...
  return (
    <div>
      ...
      {showDetail && (
        <div className="absolute top-0 left-0 z-10 grid w-full h-auto p-2 text-black bg-gray-100 shadow-custom-light dark:shadow-custom-dark md:grid-cols-2 gap-x-12 dark:text-gray-300 dark:bg-dark-50">
          <div>
