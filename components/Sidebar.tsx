...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      <a className='flex items-center justify-center px-2 py-1 my-4 bg-gray-200 rounded-full dark:bg-dark-100' href='AdiMunawar.pdf' download='adi.jpg' rel='canonical'>
