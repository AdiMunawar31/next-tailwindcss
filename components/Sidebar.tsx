...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      <p className="px-2 py-1 my-2 bg-gray-200 rounded-full dark:bg-dark-100">Developer</p>
      <a
      ...
      <div className="flex justify-around mx-auto my-6 text-blue-500">
        <a href="https://www.youtube.com/@adimunawar2105" target="_blank" rel="noreferrer" aria-label="Youtube">
